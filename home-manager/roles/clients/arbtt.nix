...
in
{
  ...
  home.file.".arbtt/categorize.cfg".text = ''
    ...
    current window $title =~ m!eomutt! ==> tag Graph:orga,
    ...
    current window $title =~ m!todo.darmstadt! ==> tag Graph:orga,
    ...
    current window $title =~ /github/ ==> tag Graph:dev,
    current window $title =~ m!git/config! ==> tag Graph:config,
    current window $title =~ [/git/,/jj/,/tig/] ==> tag Graph:dev,
