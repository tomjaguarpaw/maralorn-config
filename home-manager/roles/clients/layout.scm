...
(define (mono view-count width height tags output)
...
(define (five view-count width height tags output)
  (letrec ((lrel (lambda (a b c d) (rel width height a b c d)))
    ...
    (cond
      ...
      ((> view-count 8)   (append (list (lrelo 0.4 0 0.2 0.5) (lrelo 0.4 0.5 0.2 0.5) (lrel 0.6 0 0.2 0.5)   (lrel 0.6 0.5 0.2 0.5))
