...
(define (three view-count width height)
  (letrec ((lrel (lambda (a b c d) (rel width height a b c d)))
    ...
    (cond
      ...
      ((eq? view-count 3)         (list (lrelo threesplit 0 (- 1 threesplit) 1) (lrel 0 0.6 threesplit 0.4) (lrel 0 0 threesplit 0.6)))
      (else               (append (list (lrelo threesplit 0 (- 1 threesplit) 1) (lrel 0 0.6 threesplit 0.4) (lrel 0 0 threesplit 0.6)) (repeat (- view-count 3) (lrelo threesplit 0 (- 1 threesplit) 1)))
      )
    )
  )
)
...
(define (five view-count width height)
  (letrec ((lrel (lambda (a b c d) (rel width height a b c d)))
    ...
    (cond
      ...
      (else               (append (list (lrelo 0.4 0 0.2 1)   (lrel 0.6 0 0.2 0.5)    (lrel 0.6 0.5 0.2 0.5))
                                  (vsplit (- view-count 6) (- view-count 5))
