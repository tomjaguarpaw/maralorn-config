...
, nonempty-containers, optics, reflex, relude, say, shh, stm
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    filepath fsnotify network nonempty-containers optics reflex relude
    say shh stm string-interpolate template-haskell time uuid
  ];
